...
The transcript was auto-generated by YouTube and may contain spelling errors, \
especially for Pokemon card names, set names, and TCG terminology — \
infer the correct terms from context when writing the summary.
